    ...
    >
      {isAdmin ? (
        ...
        <TableSelectorContent
          tables={tables.filter((t) => t.status === TableStatus.Available)}
          selectedTable={selectedTable}
          setSelectedTable={setSelectedTable}
          setTableId={setTableId}
        />
...
const TableSelectorContent = ({
  ...
  const filteredTables = useMemo(() => {
    const result = tables.filter(
      (r) => r.capacity >= capacityFilter[0] && r.capacity <= capacityFilter[1],
    );
        ...
        <PopoverContent className="w-80">
          <div className="grid gap-4">
            ...
            <div className="grid gap-2">
              {statusFilter !== undefined && setStatusFilter !== undefined && (
